...
class RemovePokemonFromTeamUseCaseTest {

    @Mock
    private ITrainerRepository trainerRepository;

    private ModelMapper modelMapper;
    private RemovePokemonFromTeamUseCase removePokemonFromTeamUseCase;

    @BeforeEach
    void setup() {
        modelMapper = new ModelMapper();
        removePokemonFromTeamUseCase = new RemovePokemonFromTeamUseCase(trainerRepository, modelMapper);
    }
    ...
    void successScenario() {
        ...
        Trainer t2 = new Trainer("testId","testName","testPokedollars", List.of());
        ...
        removePokemonFromTeamUseCase.transferToPc("testId", pokemonDTO);

        StepVerifier.create(trainerRepository.save(t2))
                .expectNextMatches(trainer -> trainer.getPokemonTeam().size() == 0)
                .verifyComplete();
